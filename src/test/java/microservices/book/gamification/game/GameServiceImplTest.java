...
public class GameServiceImplTest {
    ...
    void processCorrectAttemptTest() {
        ...
        var attempt = new ChallengeSolvedEvent(attemptId, true, 20, 70, userId, "nicolai");
    ...
    void processWrongAttemptTest() {
        ...
        GameResult gameResult =
                gameService.newAttemptForUser(new ChallengeSolvedEvent(10L, false, 10, 10, 1L, "nicolai"));
