...
public class AMQPConfiguration {
    ...
    @Bean
    public RabbitListenerConfigurer rabbitListenerConfigurer(final MessageHandlerMethodFactory messageHandler) {
        return (c) -> c.setMessageHandlerMethodFactory(messageHandler);
    }
}
